...
# from sklearn.metrics import mean_absolute_error
# # Download Stock Data
# # Select stock (change only this line)
# stock_symbol = "AAPL"   # Apple / TSLA / GOOGL
...
# # Shift Close price upward (next day prediction)
# df["Target_Close"] = df["Close"].shift(-1)
...
# # Train-Test Split
# X_train, X_test, y_train, y_test = train_test_split(
#     X, y, test_size=0.2, shuffle=False #shuffle=False → important for time series data
# )#✔ Requirement: Time series handling ✅
# # Train Model
# model = LinearRegression()
# model.fit(X_train, y_train)
# # Prediction & Evaluation
...
# plt.savefig("outputs/stock_prediction.png")
# plt.show()
